! function(e, t, n) {
    ...
    function r(e) {
        ...
        if (T && (t = t.baseVal), _._config.enableJSClass) {
    ...
    function u(e, n, i, r) {
        ...
        if (parseInt(i, 10))
            for (; i--;)(l = a("div")).id = r ? r[i] : u + (i + 1), d.appendChild(l);
        return (o = a("style")).type = "text/css", o.id = "s" + u, (f.fake ? f : d).appendChild(o), f.appendChild(d), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(t.createTextNode(e)), d.id = u, f.fake && (f.style.background = "", f.style.overflow = "hidden", c = E.style.overflow, E.style.overflow = "hidden", E.appendChild(f)), s = n(d, e), f.fake ? (f.parentNode.removeChild(f), E.style.overflow = c, E.offsetHeight) : d.parentNode.removeChild(d), !!s
    }
    ...
    function p(t, i) {
        ...
        if ("CSS" in e && "supports" in e.CSS) {
            for (; r--;)
                if (e.CSS.supports(s(t[r]), i)) return !0;
            return !1
        }
        if ("CSSSupportsRule" in e) {
            for (var o = []; r--;) o.push("(" + s(t[r]) + ":" + i + ")");
    ...
    function h(e, t, r, o) {
        ...
        for (var d, f, h, g, m, v = ["modernizr", "tspan", "samp"]; !L.style && v.length;) d = !0, L.modElem = a(v.shift()), L.style = L.modElem.style;
        for (h = e.length, f = 0; h > f; f++)
            if (g = e[f], m = L.style[g], c(g, "-") && (g = l(g)), L.style[g] !== n) {
                if (o || i(r, "undefined")) return s(), "pfx" != t || g;
                try {
                    L.style[g] = r
                } catch (e) {}
                if (L.style[g] != m) return s(), "pfx" != t || g
            }
        return s(), !1
    }
    ...
    _.addTest("websockets", w), _.addTest("customelements", "customElements" in e), _.addTest("history", function() {
        var t = navigator.userAgent;
        return (-1 === t.indexOf("Android 2.") && -1 === t.indexOf("Android 4.0") || -1 === t.indexOf("Mobile Safari") || -1 !== t.indexOf("Chrome") || -1 !== t.indexOf("Windows Phone") || "file:" === location.protocol) && (e.history && "pushState" in e.history)
    }), _.addTest("postmessage", "postMessage" in e), _.addTest("webworkers", "Worker" in e), _.addTest("picture", "HTMLPictureElement" in e);
    ...
    T || function(e, t) {
        ...
        function r(e, n, r) {
            return n || (n = t), l ? n.createElement(e) : (r || (r = i(n)), !(o = r.cache[e] ? r.cache[e].cloneNode() : d.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e)).canHaveChildren || u.test(e) || o.tagUrn ? o : r.frag.appendChild(o));
            var o
        }
        ...
        var g = {
            ...
            createDocumentFragment: function(e, r) {
                ...
                for (var o = (r = r || i(e)).frag.cloneNode(), s = 0, a = n(), c = a.length; c > s; s++) o.createElement(a[s]);
                return o
            },
            addElements: function(e, t) {
                var n = g.elements;
                "string" != typeof n && (n = n.join(" ")), "string" != typeof e && (e = e.join(" ")), g.elements = n + " " + e, s(t)
            }
        };
        e.html5 = g, s(t), "object" == typeof module && module.exports && (module.exports = g)
    }(void 0 !== e ? e : this, t);
    var A, C = "Moz O ms Webkit",
        S = b._config.usePrefixes ? C.toLowerCase().split(" ") : [];
    b._domPrefixes = S,
        function() {
    ...
    var j = function(t) {
        ...
        if (!t) return !1;
        if ((i = (t = t.replace(/^@/, "")).replace(/-/g, "_").toUpperCase() + "_RULE") in o) return "@" + t;
        for (var s = 0; r > s; s++) {
            var a = x[s];
            if (a.toUpperCase() + "_" + i in o) return "@-" + a.toLowerCase() + "-" + t
        }
        return !1
    };
    b.atRule = j;
    var O = function() {
        ...
        return function(t, i) {
            var r;
            return !!t && (i && "string" != typeof i || (i = a(i || "div")), !(r = (t = "on" + t) in i) && e && (i.setAttribute || (i = a("div")), i.setAttribute(t, ""), r = "function" == typeof i[t], i[t] !== n && (i[t] = n), i.removeAttribute(t)), r)
        }
    }();
    b.hasEvent = O, _.addTest("pointerevents", function() {
        var e = !1,
            t = S.length;
        for (e = _.hasEvent("pointerdown"); t-- && !e;) O(S[t] + "pointerdown") && (e = !0);
        return e
    });
    b.prefixedCSSValue = function(e, t) {
        ...
        return "" === n && (n = !1), n
    }, _.addTest("webanimations", "animate" in a("div")), _.addTest("webgl", function() {
        var t = a("canvas"),
        ...
        var e, t, n = a("img"),
            i = "sizes" in n;
        !i && "srcset" in n ? ("data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw==", e = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", t = function() {
            o("sizes", 2 == n.width)
        }, n.onload = t, n.onerror = t, n.setAttribute("sizes", "9px"), n.srcset = e + " 1w,data:image/gif;base64,R0lGODlhAgABAPAAAP///wAAACH5BAAAAAAALAAAAAACAAEAAAICBAoAOw== 8w", n.src = e) : o("sizes", i)
    }), _.addTest("srcset", "srcset" in a("img"));
    var N = function() {
    ...
    var P = b.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? j(e) : (-1 != e.indexOf("-") && (e = l(e)), t ? g(e, t, n) : g(e, "pfx"))
    };
    b.prefixedCSS = function(e) {
            var t = P(e);
            return t && s(t)
        }, b.testAllProps = m, _.addTest("flexbox", m("flexBasis", "1px", !0)), _.addTest("cssanimations", m("animationName", "a", !0)),
        function() {
        ...
        function() {
            ...
            for (var a in y)
                if (y.hasOwnProperty(a)) {
                    ...
                    for (r = i(t.fn, "function") ? t.fn() : t.fn, o = 0; o < e.length; o++) 1 === (s = e[o].split(".")).length ? _[s[0]] = r : (!_[s[0]] || _[s[0]] instanceof Boolean || (_[s[0]] = new Boolean(_[s[0]])), _[s[0]][s[1]] = r), v.push((r ? "" : "no-") + s.join("-"))
                }
        }(), r(v), delete b.addTest, delete b.addAsyncTest;
...
function(e, t) {
    ...
    w.fn = w.prototype = {
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== c.call(e) || (t = i(e)) && ("function" != typeof(n = u.call(t, "constructor") && t.constructor) || d.call(n) !== f))
        },
    ...
    var E = function(e) {
        var t, n, i, r, o, s, a, l, c, u, d, f, p, h, g, m, v, y, b, _ = "sizzle" + 1 * new Date,
            w = e.document,
            x = 0,
            E = 0,
            T = le(),
        ...
        function ae(e, t, i, r) {
            var o, a, c, u, d, h, v, y = t && t.ownerDocument,
                w = t ? t.nodeType : 9;
            ...
            if (!r && (f(t), t = t || p, g)) {
                ...
                if (n.qsa && !S[e + " "] && (!m || !m.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    if (v = e, y = t, 1 === w && (Q.test(e) || z.test(e))) {
                        for ((y = ee.test(e) && ve(t.parentNode) || t) === t && n.scope || ((u = t.getAttribute("id")) ? u = u.replace(ie, re) : t.setAttribute("id", u = _)), a = (h = s(e)).length; a--;) h[a] = (u ? "#" + u : ":scope") + " " + be(h[a]);
                        v = h.join(",")
                    }
                    try {
        ...
        for (t in n = ae.support = {}, o = ae.isXML = function(e) {
                ...
                return s != p && 9 === s.nodeType && s.documentElement && (h = (p = s).documentElement, g = !o(p), w != p && (r = p.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", oe, !1) : r.attachEvent && r.attachEvent("onunload", oe)), n.scope = ue(function(e) {
                    ...
                    return i || (1 & (i = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e == p || e.ownerDocument == w && b(w, e) ? -1 : t == p || t.ownerDocument == w && b(w, t) ? 1 : u ? M(u, e) - M(u, t) : 0 : 4 & i ? -1 : 1)
                } : function(e, t) {
                    if (e === t) return d = !0, 0;
                    var n, i = 0,
                        r = e.parentNode,
                        ...
                        return 1 === i && 0 === r ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (h = [s ? m.firstChild : m.lastChild], s && y) {
                                    ...
                                    for (;
                                        (f = ++p && f && f[g] || (b = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && ((u = (d = f[_] || (f[_] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [x, b]), f !== t)););
        ...
        function Ee(e, t, n, i, r, o) {
            return i && !i[_] && (i = Ee(i)), r && !r[_] && (r = Ee(r, o)), ce(function(o, s, a, l) {
                var c, u, d, f = [],
                    ...
                    v = n ? r || (o ? e : h || i) ? [] : s : m;
                if (n && n(m, v, a, l), i)
                    for (c = xe(v, p), i(c, [], a, l), u = c.length; u--;)(d = c[u]) && (v[p[u]] = !(m[p[u]] = d));
                if (o) {
                    if (r || e) {
                        if (r) {
                        ...
                        for (u = v.length; u--;)(d = v[u]) && -1 < (c = r ? M(o, d) : f[u]) && (o[c] = !(s[c] = d))
                    }
                } else v = xe(v === s ? v.splice(h, v.length) : v), r ? r(null, s, v, l) : L.apply(s, v)
            })
        }
            ...
            for (var t, n, r, o = e.length, s = i.relative[e[0].type], a = s || i.relative[" "], l = s ? 1 : 0, u = _e(function(e) {
                ...
                if (n = i.relative[e[l].type]) f = [_e(we(f), n)];
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[_]) {
                        ...
                        return Ee(1 < l && we(f), 1 < l && be(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace($, "$1"), n, l < r && Te(e.slice(l, r)), r < o && Te(e = e.slice(r)), r < o && be(e))
                    }
                    f.push(n)
                }
            return we(f)
        ...
        return ye.prototype = i.filters = i.pseudos, i.setFilters = new ye, s = ae.tokenize = function(e, t) {
            ...
            if (!m) {
                ...
                (m = C(e, (r = h, a = 0 < (o = d).length, l = 0 < r.length, u = function(e, t, n, s, u) {
                    var d, h, m, v = 0,
                        y = "0",
                        b = e && [],
                        _ = [],
                        ...
                        A = E.length;
                    for (u && (c = t == p || t || u); y !== A && null != (d = E[y]); y++) {
                        if (l && d) {
                            for (h = 0, t || d.ownerDocument == p || (f(d), n = !g); m = r[h++];)
                                if (m(d, t || p, n)) {
                                    s.push(d);
                                    break
                                }
                    ...
                    if (v += y, a && y !== v) {
                        for (h = 0; m = o[h++];) m(b, _, t, n);
                        if (e) {
                            if (0 < v)
                                for (; y--;) b[y] || _[y] || (_[y] = N.call(s));
                            _ = xe(_)
                        }
                        L.apply(s, _), u && !e && 0 < _.length && 1 < v + o.length && ae.uniqueSort(s)
                    }
                    return u && (x = T, c = w), b
                }, a ? ce(u) : u))).selector = e
            }
        ...
        }, n.sortStable = _.split("").sort(k).join("") === _, n.detectDuplicates = !!d, f(), n.sortDetached = ue(function(e) {
    ...
    w.filter = function(e, t, n) {
        ...
        is: function(e) {
            return !!j(this, "string" == typeof e && C.test(e) ? w(e) : e || [], !1).length
        }
    });
    var O, N = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    (w.fn.init = function(e, t, n) {
        ...
        if (n = n || O, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : m, !0)), k.test(i[1]) && w.isPlainObject(t))
    ...
    w.fn.extend({
        ...
        w.fn[e] = function(n, i) {
            ...
            return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = w.filter(i, r)), 1 < this.length && (L[e] || w.uniqueSort(r), D.test(e) && r.reverse()), this.pushStack(r)
        }
    });
    var M = /[^\x20\t\r\n\f]+/g;
    ...
    w.Callbacks = function(e) {
                ...
                r = {
                    ...
                    then: function(t, i, r) {
                                ...
                                var a = this,
                                    ...
                                    c = function() {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, h(c) ? r ? c.call(e, s(o, n, I, r), s(o, n, H, r)) : (o++, c.call(e, s(o, n, I, r), s(o, n, H, r), s(o, n, I, n.notifyWith))) : (i !== I && (a = void 0, l = [e]), (r || n.resolveWith)(a, l))
                                        }
                                    },
                                    u = r ? c : function() {
                                        try {
                        ...
                        return w.Deferred(function(e) {
                            n[0][3].add(s(0, e, h(r) ? r : I, e.notifyWith)), n[1][3].add(s(0, e, h(t) ? t : I)), n[2][3].add(s(0, e, h(i) ? i : H))
                        }).promise()
                    },
                    promise: function(e) {
        ...
        when: function(e) {
            ...
            if (t <= 1 && (q(e, s.done(a(n)).resolve, s.reject, !t), "pending" === s.state() || h(o[n] && o[n].then))) return s.then();
    ...
    var $ = function(e, t, n, i, r, o, s) {
            ...
            else if (void 0 !== i && (r = !0, h(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function(e, t, n) {
                    return c.call(w(e), n)
                })), t))
    ...
    function be(e, t, n, i, r) {
        for (var o, s, a, l, c, u, d = t.createDocumentFragment(), f = [], p = 0, h = e.length; p < h; p++)
            ...
            for (s = s || d.appendChild(t.createElement("div")), a = (pe.exec(o) || ["", ""])[1].toLowerCase(), l = ge[a] || ge._default, s.innerHTML = l[1] + w.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
    ...
    w.event = {
        ...
        add: function(e, t, n, i, r) {
            var o, s, a, l, c, u, d, f, p, h, g, m = Y.get(e);
            if (V(e))
                for (n.handler && (n = (o = n).handler, r = o.selector), r && w.find.matchesSelector(ie, r), n.guid || (n.guid = w.guid++), (l = m.events) || (l = m.events = Object.create(null)), (s = m.handle) || (s = m.handle = function(t) {
                    ...
                    }), c = (t = (t || "").match(M) || [""]).length; c--;) p = g = (a = _e.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), p && (d = w.event.special[p] || {}, p = (r ? d.delegateType : d.bindType) || p, d = w.event.special[p] || {}, u = w.extend({
                    type: p,
                    origType: g,
                    data: i,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, o), (f = l[p]) || ((f = l[p] = []).delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, h, s) || e.addEventListener && e.addEventListener(p, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? f.splice(f.delegateCount++, 0, u) : f.push(u), w.event.global[p] = !0)
        },
            ...
            if (m && (l = m.events)) {
                for (c = (t = (t || "").match(M) || [""]).length; c--;)
                    if (p = g = (a = _e.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                        for (d = w.event.special[p] || {}, f = l[p = (i ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--;) u = f[o], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(o, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && S(t, "input") && Ae(t, "click", we), !1
                },
                trigger: function(e) {
                    var t = this || e;
    ...
    function Le(e, t, n, i) {
        ...
        var r, s, a, l, c, u, d = 0,
            ...
            m = t[0],
            v = h(m);
        if (v || 1 < f && "string" == typeof m && !p.checkClone && Se.test(m)) return e.each(function(r) {
            var o = e.eq(r);
            v && (t[0] = m.call(this, r, o.html())), Le(o, t, n, i)
        });
        if (f && (s = (r = be(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = s), s || i)) {
            for (l = (a = w.map(me(r, "script"), Oe)).length; d < f; d++) c = r, d !== g && (c = w.clone(c, !0, !0), l && w.merge(a, me(c, "script"))), n.call(e[d], c, d);
            if (l)
                for (u = a[a.length - 1].ownerDocument, w.map(a, Ne), d = 0; d < l; d++) c = a[d], he.test(c.type || "") && !Y.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
    ...
    w.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    for (o = o || me(e), s = s || me(u), i = 0, r = o.length; i < r; i++) De(o[i], s[i]);
                else De(e, u);
    ...
    function Re(e, t, n) {
        ...
        return (n = n || Ie(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || re(e) || (s = w.style(e, t)), !p.pixelBoxStyles() && Me.test(s) && qe.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function ze(e) {
        return w.cssProps[e] || Fe[e] || (e in $e ? e : Fe[e] = function(e) {
    ...
    function Ge(e, t, n) {
        ...
        return (!p.boxSizingReliable() && r || !p.reliableTrDimensions() && S(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === w.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === w.css(e, "boxSizing", !1, i), (o = a in e) && (s = e[a])), (s = parseFloat(s) || 0) + Ke(e, t, n || (r ? "border" : "content"), o, i, s) + "px"
    }
    ...
    w.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (o = typeof n) && (r = te.exec(n)) && r[1] && (n = ae(e, t, r), o = "number"), null != n && n == n && ("number" !== o || l || (n += r && r[3] || (w.cssNumber[a] ? "" : "px")), p.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n))
            }
        },
        css: function(e, t, n, i) {
            var r, o, s, a = U(t);
            return Ue.test(t) || (t = ze(a)), (s = w.cssHooks[t] || w.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = Re(e, t, i)), "normal" === r && t in Xe && (r = Xe[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), w.each(["height", "width"], function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) return !Qe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, t, i) : He(e, Ve, function() {
                    return Ge(e, t, i)
                })
            },
            set: function(e, n, i) {
                var r, o = Ie(e),
                    ...
                    l = i ? Ke(e, t, i, a, o) : 0;
                return a && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Ke(e, t, "border", !1, o) - .5)), l && (r = te.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = w.css(e, t)), Ye(0, n, l)
            }
        }
        ...
        css: function(e, t) {
            return $(this, function(e, t, n) {
                var i, r, o = {},
                    s = 0;
                if (Array.isArray(t)) {
                    for (i = Ie(e), r = t.length; s < r; s++) o[t[s]] = w.css(e, t[s], !1, i);
                    return o
                }
    ...
    function ct(e, t, n) {
        var i, r, o = 0,
            ...
            l = function() {
                if (r) return !1;
                for (var t = Ze || st(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), o = 0, s = c.tweens.length; o < s; o++) c.tweens[o].run(i);
        ...
        for (function(e, t) {
            ...
            if (i = ct.prefilters[o].call(c, e, u, c.opts)) return h(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
    ...
    w.Animation = w.extend(ct, {
        ...
        prefilters: [function(e, t, n) {
            ...
            if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(p))
                for (i in d && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = m && m.display) && (c = Y.get(e, "display")), "none" === (u = w.css(e, "display")) && (c ? u = c : (ce([e], !0), c = e.style.display || c, u = w.css(e, "display"), ce([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === w.css(e, "float") && (l || (f.done(function() {
                        h.display = c
                    ...
                    display: c
                }), o && (m.hidden = !g), g && ce([e], !0), f.done(function() {
                    for (i in g || ce([e]), Y.remove(e, "fxshow"), p) w.style(e, i, p[i])
    ...
    w.extend(w.event, {
        trigger: function(t, n, i, r) {
            var o, s, a, l, c, d, f, p, v = [i || m],
                y = u.call(t, "type") ? t.type : t,
                b = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = p = a = i = i || m, 3 !== i.nodeType && 8 !== i.nodeType && !yt.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), c = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = r ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : w.makeArray(n, [t]), f = w.event.special[y] || {}, r || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                if (!r && !f.noBubble && !g(i)) {
                    for (l = f.delegateType || y, yt.test(l + y) || (s = s.parentNode); s; s = s.parentNode) v.push(s), a = s;
                    a === (i.ownerDocument || m) && v.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0;
                    (s = v[o++]) && !t.isPropagationStopped();) p = s, t.type = 1 < o ? l : f.bindType || y, (d = (Y.get(s, "events") || Object.create(null))[t.type] && Y.get(s, "handle")) && d.apply(s, n), (d = c && s[c]) && d.apply && V(s) && (t.result = d.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = y, r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !V(i) || c && h(i[y]) && !g(i) && ((a = i[c]) && (i[c] = null), w.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, bt), i[y](), t.isPropagationStopped() && p.removeEventListener(y, bt), w.event.triggered = void 0, a && (i[c] = a)), t.result
            }
        },
    ...
    function St(e, t, n, i) {
        ...
        if (Array.isArray(t)) w.each(t, function(t, r) {
            n || Et.test(e) ? i(e, r) : St(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    w.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !w(this).is(":disabled") && Ct.test(this.nodeName) && !At.test(e) && (this.checked || !fe.test(e))
            }).map(function(e, t) {
                var n = w(this).val();
    ...
    Ht.href = _t.href, w.extend({
        ...
        ajax: function(t, n) {
            ...
            var i, r, o, s, a, l, c, u, d, f, p = w.ajaxSetup({}, n),
                h = p.context || p,
            ...
            if (v.promise(T), p.url = ((t || p.url || _t.href) + "").replace(Lt, _t.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(M) || [""], null == p.crossDomain) {
                l = m.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)), Rt(Pt, p, n, T), c) return T;
            for (d in (u = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Dt.test(p.type), r = p.url.replace(jt, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(kt, "+")) : (f = p.url.slice(r.length), p.data && (p.processData || "string" == typeof p.data) && (r += (xt.test(r) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (r = r.replace(Ot, "$1"), f = (xt.test(r) ? "&" : "?") + "_=" + wt.guid++ + f), p.url = r + f), p.ifModified && (w.lastModified[r] && T.setRequestHeader("If-Modified-Since", w.lastModified[r]), w.etag[r] && T.setRequestHeader("If-None-Match", w.etag[r])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + It + "; q=0.01" : "") : p.accepts["*"]), p.headers) T.setRequestHeader(d, p.headers[d]);
            if (p.beforeSend && (!1 === p.beforeSend.call(h, T, p) || c)) return T.abort();
            if (E = "abort", y.add(p.complete), T.done(p.success), T.fail(p.error), i = Rt(Mt, p, n, T)) {
            ...
            function A(t, n, s, l) {
                var d, f, m, _, x, E = n;
                c || (c = !0, a && e.clearTimeout(a), i = void 0, o = l || "", T.readyState = 0 < t ? 4 : 0, d = 200 <= t && t < 300 || 304 === t, s && (_ = function(e, t, n) {
                ...
                }(p, T, s)), !d && -1 < w.inArray("script", p.dataTypes) && w.inArray("json", p.dataTypes) < 0 && (p.converters["text script"] = function() {}), _ = function(e, t, n, i) {
                    var r, o, s, a, l, c = {},
                        u = e.dataTypes.slice();
                    if (u[1])
                ...
                }(p, _, T, d), d ? (p.ifModified && ((x = T.getResponseHeader("Last-Modified")) && (w.lastModified[r] = x), (x = T.getResponseHeader("etag")) && (w.etag[r] = x)), 204 === t || "HEAD" === p.type ? E = "nocontent" : 304 === t ? E = "notmodified" : (E = _.state, f = _.data, d = !(m = _.error))) : (m = E, !t && E || (E = "error", t < 0 && (t = 0))), T.status = t, T.statusText = (n || E) + "", d ? v.resolveWith(h, [f, E, T]) : v.rejectWith(h, [T, E, m]), T.statusCode(b), b = void 0, u && g.trigger(d ? "ajaxSuccess" : "ajaxError", [T, p, d ? f : m]), y.fireWith(h, [T, E]), u && (g.trigger("ajaxComplete", [T, p]), --w.active || w.event.trigger("ajaxStop")))
            }
            return T
        },
    ...
    w.ajaxSetup({
        ...
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = h(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Qt, "$1" + r) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
            return s || w.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
            s = arguments
        }, i.always(function() {
            void 0 === o ? w(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, zt.push(r)), s && h(o) && o(s[0]), s = o = void 0
        }), "script"
    }), p.createHTMLDocument = ((Ft = m.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Ft.childNodes.length), w.parseHTML = function(e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (p.createHTMLDocument ? ((i = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href, t.head.appendChild(i)) : t = m), o = !n && [], (r = k.exec(e)) ? [t.createElement(r[1])] : (r = be([e], t, o), o && o.length && w(o).remove(), w.merge([], r.childNodes)));
        var i, r, o
    }, w.fn.load = function(e, t, n) {
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = ht(e.slice(a)), e = e.slice(0, a)), h(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), 0 < s.length && w.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function(e, t, n) {
            var i, r, o, s, a, l, c = w.css(e, "position"),
                u = w(e),
                d = {};
            "static" === c && (e.style.position = "relative"), a = u.offset(), o = w.css(e, "top"), l = w.css(e, "left"), ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (s = (i = u.position()).top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), h(t) && (t = t.call(e, n, w.extend({}, a))), null != t.top && (d.top = t.top - a.top + s), null != t.left && (d.left = t.left - a.left + r), "using" in t ? t.using.call(e, d) : u.css(d)
        }
    }, w.fn.extend({
        offset: function(e) {
        ...
        w.cssHooks[t] = Be(p.pixelPosition, function(e, n) {
            if (n) return n = Re(e, t), Me.test(n) ? w(e).position()[t] + "px" : n
        })
    }), w.each({
        Height: "height",
        Width: "width"
    ...
    }, w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = S, w.isFunction = h, w.isWindow = g, w.camelCase = U, w.type = b, w.now = Date.now, w.isNumeric = function(e) {
        var t = w.type(e);
    ...
    function(e) {
        ...
        function r(n) {
            var r = t.console;
            e.migrateDeduplicateWarnings && i[n] || (i[n] = !0, e.migrateWarnings.push(n), r && r.warn && !e.migrateMute && (r.warn("JQMIGRATE: " + n), e.migrateTrace && r.trace && r.trace()))
        }
        ...
        for (a in e.fn.init = function(e) {
                ...
                return "string" == typeof e && "#" === e && (r("jQuery( '#' ) is not a valid selector"), t[0] = []), d.apply(this, t)
            ...
            }, f) Object.prototype.hasOwnProperty.call(f, a) && (e.find[a] = f[a]);
        s(e.fn, "size", function() {
            return this.length
        }, "jQuery.fn.size() is deprecated and removed; use the .length property"), s(e, "parseJSON", function() {
            return JSON.parse.apply(null, arguments)
        }, "jQuery.parseJSON is deprecated; use JSON.parse"), s(e, "holdReady", e.holdReady, "jQuery.holdReady is deprecated"), s(e, "unique", e.uniqueSort, "jQuery.unique is deprecated; use jQuery.uniqueSort"), o(e.expr, "filters", e.expr.pseudos, "jQuery.expr.filters is deprecated; use jQuery.expr.pseudos"), o(e.expr, ":", e.expr.pseudos, "jQuery.expr[':'] is deprecated; use jQuery.expr.pseudos"), n("3.1.1") && s(e, "trim", function(e) {
            ...
            !1 !== e.jsonp && (c.test(e.url) || "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && c.test(e.data)) && r("JSON-to-JSONP auto-promotion is deprecated")
        }));
        ...
        var _, w = !(e.fn.toggleClass = function(t) {
                return void 0 !== t && "boolean" != typeof t ? v.apply(this, arguments) : (r("jQuery.fn.toggleClass( boolean ) is deprecated"), this.each(function() {
        ...
        e.swap && e.each(["height", "width", "reliableMarginRight"], function(t, n) {
            ...
            var o, s, a = {};
            for (s in w || r("jQuery.swap() is undocumented and deprecated"), t) a[s] = e.style[s], e.style[s] = t[s];
            for (s in o = n.apply(e, i || []), t) e.style[s] = a[s];
            return o
        }, n("3.4.0") && "undefined" != typeof Proxy && (e.cssProps = new Proxy(e.cssProps || {}, {
            set: function() {
                return r("JQMIGRATE: jQuery.cssProps is deprecated"), Reflect.set.apply(this, arguments)
            }
        })), e.cssNumber || (e.cssNumber = {}), _ = e.fn.css, e.fn.css = function(t, n) {
            var i, o, s = this;
            return t && "object" == typeof t && !Array.isArray(t) ? (e.each(t, function(t, n) {
                e.fn.css.call(s, t, n)
            }), this) : ("number" == typeof n && (o = i = b(t), x.test(o) && E.test(o[0].toUpperCase() + o.slice(1)) || e.cssNumber[i] || r('Number-typed values are deprecated for jQuery.fn.css( "' + t + '", value )')), _.apply(this, arguments))
        };
        var T, A, C, S, k = e.data;
        e.data = function(t, n, i) {
            var o, s, a;
            if (n && "object" == typeof n && 2 === arguments.length) {
                for (a in o = e.hasData(t) && k.call(this, t), s = {}, n) a !== b(a) ? (r("jQuery.data() always sets/gets camelCased names: " + a), o[a] = n[a]) : s[a] = n[a];
                return k.call(this, t, s), n
            }
            return n && "string" == typeof n && n !== b(n) && (o = e.hasData(t) && k.call(this, t)) && n in o ? (r("jQuery.data() always sets/gets camelCased names: " + n), 2 < arguments.length && (o[n] = i), o[n]) : k.apply(this, arguments)
        }, e.fx && (C = e.Tween.prototype.run, S = function(e) {
            return e
        }, e.Tween.prototype.run = function() {
            1 < e.easing[this.easing].length && (r("'jQuery.easing." + this.easing.toString() + "' should use only one argument"), e.easing[this.easing] = S), C.apply(this, arguments)
        }, T = e.fx.interval || 13, A = "jQuery.fx.interval is deprecated", t.requestAnimationFrame && Object.defineProperty(e.fx, "interval", {
            configurable: !0,
            enumerable: !0,
            get: function() {
                return t.document.hidden || r(A), T
            },
            set: function(e) {
                r(A), T = e
            }
        ...
        function L(e) {
            ...
            t !== e && D(e) !== D(t) && r("HTML tags must be properly nested and closed: " + e)
        }
        e.event.props = [], e.event.fixHooks = {}, o(e.event.props, "concat", e.event.props.concat, "jQuery.event.props.concat() is deprecated and removed"), e.event.fix = function(t) {
            var n, i = t.type,
                o = this.fixHooks[i],
                s = e.event.props;
            if (s.length)
                for (r("jQuery.event.props are deprecated and removed: " + s.join()); s.length;) e.event.addProp(s.pop());
            if (o && !o._migrated_ && (o._migrated_ = !0, r("jQuery.event.fixHooks are deprecated and removed: " + i), (s = o.props) && s.length))
                for (; s.length;) e.event.addProp(s.pop());
            return n = N.call(this, t), o && o.filter ? o.filter(n, t) : n
        }, e.event.add = function(e, n) {
            return e === t && "load" === n && "complete" === t.document.readyState && r("jQuery(window).on('load'...) called after load event occurred"), O.apply(this, arguments)
        }, e.each(["load", "unload", "error"], function(t, n) {
            e.fn[n] = function() {
                var e = Array.prototype.slice.call(arguments, 0);
                return "load" === n && "string" == typeof e[0] ? j.apply(this, e) : (r("jQuery.fn." + n + "() is deprecated"), e.splice(0, 0, n), arguments.length ? this.on.apply(this, e) : (this.triggerHandler.apply(this, e), this))
            }
        }), e.each("blur focus focusin focusout resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu".split(" "), function(t, n) {
            e.fn[n] = function(e, t) {
                return r("jQuery.fn." + n + "() event shorthand is deprecated"), 0 < arguments.length ? this.on(n, null, e, t) : this.trigger(n)
            }
        }), e(function() {
        ...
        e.fn.offset = function() {
            var e = this[0];
            return !e || e.nodeType && e.getBoundingClientRect ? H.apply(this, arguments) : (r("jQuery.fn.offset() requires a valid DOM element"), arguments.length ? this : void 0)
        }, e.ajax && (I = e.param, e.param = function(t, n) {
            var i = e.ajaxSettings && e.ajaxSettings.traditional;
            return void 0 === n && i && (r("jQuery.param() no longer uses jQuery.ajaxSettings.traditional"), n = i), I.call(this, t, n)
        });
        var q, R, B = e.fn.andSelf || e.fn.addBack;
        return e.fn.andSelf = function() {
            return r("jQuery.fn.andSelf() is deprecated and removed, use jQuery.fn.addBack()"), B.apply(this, arguments)
        }, e.Deferred && (q = e.Deferred, R = [
                ...
                return r("deferred.pipe() is deprecated"), e.Deferred(function(r) {
                    e.each(R, function(e, o) {
                        ...
                        n[o[1]](function() {
                            ...
                            e && "function" == typeof e.promise ? e.promise().done(r.resolve).fail(r.reject).progress(r.notify) : r[o[0] + "With"](this === i ? r.promise() : this, s ? [e] : arguments)
                        })
                    }), t = null
                }).promise()
            }, t && t.call(n, n), n
    ...
    function(e, t) {
        ...
        function f(e, r, s) {
            ...
            return (u || !u && !s) && (("body" !== a(r) || d(f)) && (p = r !== n(r) && o(r) ? {
                scrollLeft: r.scrollLeft,
                scrollTop: r.scrollTop
            } : i(r)), o(r) ? ((h = t(r)).x += r.clientLeft, h.y += r.clientTop) : f && (h.x = c(f))), {
        ...
        function p(e) {
            var n = t(e),
                i = e.offsetWidth,
                r = e.offsetHeight;
            return 1 >= Math.abs(n.width - i) && (i = n.width), 1 >= Math.abs(n.height - r) && (r = n.height), {
                x: e.offsetLeft,
                y: e.offsetTop,
                width: i,
                height: r
        ...
        function g(e, t) {
            ...
            void 0 === t && (t = []);
            var r = function e(t) {
                return 0 <= ["html", "body", "#document"].indexOf(a(t)) ? t.ownerDocument.body : o(t) && d(t) ? t : e(h(t))
            }(e);
            return e = r === (null == (i = e.ownerDocument) ? void 0 : i.body), i = n(r), r = e ? [i].concat(i.visualViewport || [], d(r) ? r : []) : r, t = t.concat(r), e ? t : t.concat(g(h(r)))
        }
        ...
        function v(e) {
            ...
            if (!i) e: {
                if (i = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox"), -1 === navigator.userAgent.indexOf("Trident") || !o(e) || "fixed" !== u(e).position)
                    for (e = h(e); o(e) && 0 > ["html", "body"].indexOf(a(e));) {
                        var r = u(e);
                        if ("none" !== r.transform || "none" !== r.perspective || "paint" === r.contain || -1 !== ["transform", "perspective"].indexOf(r.willChange) || i && "filter" === r.willChange || i && r.filter && "none" !== r.filter) {
                            i = e;
                            break e
                        }
                        e = e.parentNode
        ...
        function E(e, r) {
            if ("viewport" === r) {
                ...
                var d = 0,
                    f = 0;
                r && (a = r.width, s = r.height, /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (d = r.offsetLeft, f = r.offsetTop)), e = x(e = {
                    width: a,
                    height: s,
                    x: d + c(e),
                    y: f
                })
            } else o(r) ? ((e = t(r)).top += r.clientTop, e.left += r.clientLeft, e.bottom = e.top + r.clientHeight, e.right = e.left + r.clientWidth, e.width = r.clientWidth, e.height = r.clientHeight, e.x = e.left, e.y = e.top) : (f = l(e), e = l(f), a = i(f), r = null == (s = f.ownerDocument) ? void 0 : s.body, s = $(e.scrollWidth, e.clientWidth, r ? r.scrollWidth : 0, r ? r.clientWidth : 0), d = $(e.scrollHeight, e.clientHeight, r ? r.scrollHeight : 0, r ? r.clientHeight : 0), f = -a.scrollLeft + c(f), a = -a.scrollTop, "rtl" === u(r || e).direction && (f += $(e.clientWidth, r ? r.clientWidth : 0) - s), e = x({
                width: s,
                height: d,
                x: f,
                y: a
        ...
        function T(e, t, n) {
            return t = "clippingParents" === t ? function(e) {
                ...
                return r(n) ? t.filter(function(e) {
                    return r(e) && w(e, n) && "body" !== a(e)
                }) : []
            }(e) : [].concat(t), (n = (n = [].concat(t, [n])).reduce(function(t, n) {
                return n = E(e, n), t.top = $(n.top, t.top), t.right = F(n.right, t.right), t.bottom = F(n.bottom, t.bottom), t.left = $(n.left, t.left), t
        ...
        function S(e) {
            ...
            if (null != (i = i ? C(i) : null)) switch (o = "y" === i ? "height" : "width", e) {
                case "start":
                    r[i] -= t[o] / 2 - n[o] / 2;
                    break;
                case "end":
        ...
        function O(e, n) {
            ...
            var c = i.altBoundary,
                u = void 0 !== c && c;
            i = k("number" != typeof(i = void 0 === (i = i.padding) ? 0 : i) ? i : j(i, q)), c = e.rects.popper, s = T(r(u = e.elements[u ? "popper" === o ? "reference" : "popper" : o]) ? u : u.contextElement || l(e.elements.popper), s, a), u = S({
                reference: a = t(e.elements.reference),
                element: c,
                strategy: "absolute",
                placement: n
            }), c = x(Object.assign({}, c, u)), a = "popper" === o ? c : a;
            var d = {
        ...
        function D(e) {
            ...
            var t = e.defaultModifiers,
                n = void 0 === t ? [] : t,
                i = void 0 === (e = e.defaultOptions) ? Q : e;
            return function(e, t, o) {
                ...
                var a = {
                    ...
                    u = {
                        ...
                        setOptions: function(o) {
                            return o = "function" == typeof o ? o(a.options) : o, s(), a.options = Object.assign({}, i, a.options, o), a.scrollParents = {
                                reference: r(e) ? g(e) : e.contextElement ? g(e.contextElement) : [],
                                popper: g(t)
                            }, o = function(e) {
                                var t = y(e);
                                ...
                                var t = [].concat(n, a.options.modifiers).reduce(function(e, t) {
                                    var n = e[t.name];
                        ...
                        forceUpdate: function() {
                            if (!c) {
                                ...
                                if (N(t, e = e.popper))
                                    for (a.rects = {
                                            reference: f(t, v(e), "fixed" === a.options.strategy),
                                            popper: p(e)
                ...
                return N(e, t) ? (u.setOptions(o).then(function(e) {
        ...
        function L(e) {
            ...
            if (f) {
                var _ = v(i),
                    w = "clientHeight",
                    x = "clientWidth";
                _ === n(i) && "static" !== u(_ = l(i)).position && "absolute" === c && (w = "scrollHeight", x = "scrollWidth"), "top" !== o && ("left" !== o && "right" !== o || "end" !== s) || (y = "bottom", p -= _[w] - r.height, p *= d ? 1 : -1), "left" !== o && ("top" !== o && "bottom" !== o || "end" !== s) || (m = "right", e -= _[x] - r.width, e *= d ? 1 : -1)
            }
            return i = Object.assign({
                position: c
            }, f && Y), d ? Object.assign({}, i, ((g = {})[y] = a ? "0" : "", g[m] = h ? "0" : "", g.transform = 1 >= (b.devicePixelRatio || 1) ? "translate(" + e + "px, " + p + "px)" : "translate3d(" + e + "px, " + p + "px, 0)", g)) : Object.assign({}, i, ((t = {})[y] = a ? p + "px" : "", t[m] = h ? e + "px" : "", t.transform = "", t))
        }
        ...
        var q = ["top", "bottom", "right", "left"],
            R = q.reduce(function(e, t) {
                return e.concat([t + "-start", t + "-end"])
            }, []),
            B = [].concat(q, ["auto"]).reduce(function(e, t) {
            ...
            K = {
                ...
                fn: function(e) {
                    ...
                    i = void 0 === i || i, n = void 0 === (n = n.roundOffsets) || n, e = {
                        ...
                        gpuAcceleration: e
                    }, null != t.modifiersData.popperOffsets && (t.styles.popper = Object.assign({}, t.styles.popper, L(Object.assign({}, e, {
                        offsets: t.modifiersData.popperOffsets,
                        position: t.options.strategy,
                        adaptive: i,
                        roundOffsets: n
                    })))), null != t.modifiersData.arrow && (t.styles.arrow = Object.assign({}, t.styles.arrow, L(Object.assign({}, e, {
                        ...
                        function() {
                            Object.keys(t.elements).forEach(function(e) {
                                ...
                                e = Object.keys(t.styles.hasOwnProperty(e) ? t.styles[e] : n[e]).reduce(function(e, t) {
                                    return e[t] = "", e
                                }, {}), o(i) && a(i) && (Object.assign(i.style, e), Object.keys(r).forEach(function(e) {
                                    i.removeAttribute(e)
                                }))
                            })
                        }
            ...
            J = {
                ...
                fn: function(e) {
                    var t = e.state,
                        ...
                        r = (e = B.reduce(function(e, n) {
                            var r = t.rects,
                                o = _(n),
                                s = 0 <= ["left", "top"].indexOf(o) ? -1 : 1,
                                a = "function" == typeof i ? i(Object.assign({}, r, {
                                    placement: n
                                })) : i;
            ...
            te = {
                ...
                fn: function(e) {
                    ...
                    if (e = e.name, !t.modifiersData[e]._skip) {
                        ...
                        u = _(n = t.options.placement), o = o || (u !== n && d ? function(e) {
                            if ("auto" === _(e)) return [];
                            var t = P(e);
                            return [M(e), t, M(t)]
                        }(n) : [P(n)]);
                        var p = [n].concat(o).reduce(function(e, n) {
                            return e.concat("auto" === _(n) ? function(e, t) {
                                void 0 === t && (t = {});
                                var n = t.boundary,
                                    i = t.rootBoundary,
                                    r = t.padding,
                        ...
                        var h = new Map;
                        u = !0;
                        for (var g = p[0], m = 0; m < p.length; m++) {
                            var v = p[m],
                                y = _(v),
                                b = "start" === A(v),
                            ...
                            if (b = w ? b ? "right" : "left" : b ? "bottom" : "top", n[x] > o[x] && (b = P(b)), x = P(b), w = [], i && w.push(0 >= E[y]), r && w.push(0 >= E[b], 0 >= E[x]), w.every(function(e) {
                                    return e
                                })) {
                                g = v, u = !1;
                                break
                    ...
                    if (a = {
                        ...
                        if (r || o) {
                            var m = "y" === d ? "top" : "left",
                                ...
                                T = i ? -h[b] / 2 : 0,
                                S = "start" === c ? f[b] : h[b];
                            c = "start" === c ? -h[b] : -f[b], h = t.elements.arrow, h = i && h ? p(h) : {
                                width: 0,
                                height: 0
                            };
                            ...
                            m = k[m], y = k[y], h = $(0, F(f[b], h[b])), S = u ? f[b] / 2 - T - h - m - g : S - h - m - g, f = u ? -f[b] / 2 + T + h + y + g : c + h + y + g, u = t.elements.arrow && v(t.elements.arrow), g = t.modifiersData.offset ? t.modifiersData.offset[t.placement][d] : 0, u = s[d] + S - g - (u ? "y" === d ? u.clientTop || 0 : u.clientLeft || 0 : 0), f = s[d] + f - g, r && (r = i ? F(x, u) : x, E = i ? $(E, f) : E, r = $(r, F(w, E)), s[d] = r, a[d] = r - w), o && (r = (o = s[n]) + l["x" === d ? "top" : "left"], l = o - l["x" === d ? "bottom" : "right"], r = i ? F(r, u) : r, i = i ? $(l, f) : l, i = $(r, F(o, i)), s[n] = i, a[n] = i - o)
                        }
                        t.modifiersData[e] = a
                    }
                },
            ...
            ie = {
                ...
                fn: function(e) {
                    var t, n = e.state,
                        ...
                        a = _(n.placement);
                    if (e = C(a), a = 0 <= ["left", "right"].indexOf(a) ? "height" : "width", o && s) {
                        ...
                        var l = p(o),
                            c = "y" === e ? "top" : "left",
                            u = "y" === e ? "bottom" : "right",
                            d = n.rects.reference[a] + n.rects.reference[e] - s[e] - n.rects.popper[a];
                        s = s[e] - n.rects.reference[e], s = (o = (o = v(o)) ? "y" === e ? o.clientHeight || 0 : o.clientWidth || 0 : 0) / 2 - l[a] / 2 + (d / 2 - s / 2), a = $(r[c], F(s, o - l[a] - r[u])), n.modifiersData[i] = ((t = {})[e] = a, t.centerOffset = a - s, t)
                    }
                },
                effect: function(e) {
                    var t = e.state;
                    if (null != (e = void 0 === (e = e.options.element) ? "[data-popper-arrow]" : e)) {
                        ...
                        w(t.elements.popper, e) && (t.elements.arrow = e)
                    }
                },
                requires: ["popperOffsets"],
            ...
            re = {
                ...
                fn: function(e) {
                    ...
                    n = I(o, n), i = I(s, i, r), r = H(n), s = H(i), t.modifiersData[e] = {
            ...
            oe = D({
                defaultModifiers: [V, X, K, G]
            }),
            se = [V, X, K, G, J, te, ne, ie, re],
            ae = D({
                defaultModifiers: se
            });
        e.applyStyles = G, e.arrow = ie, e.computeStyles = K, e.createPopper = ae, e.createPopperLite = oe, e.defaultModifiers = se, e.detectOverflow = O, e.eventListeners = V, e.flip = te, e.hide = re, e.offset = J, e.popperGenerator = D, e.popperOffsets = X, e.preventOverflow = ne, Object.defineProperty(e, "__esModule", {
            value: !0
        })
    }),
    function(e, t) {
        ...
        const t = function(e) {
            ...
            _ = (e, t, i = !0) => {
                ...
                const a = ({
                    ...
                    i === t && (o = !0, t.removeEventListener(n, a), b(e))
                };
        ...
        function P(e, t, n, i, r) {
            ...
            const [o, s, a] = L(t, n, i), l = N(e), c = l[a] || (l[a] = {}), u = D(c, s, o ? n : null);
            if (u) return void(u.oneOff = u.oneOff && r);
            const d = O(s, t.replace(x, "")),
                f = o ? function(e, t, n) {
                    return function i(r) {
                        ...
                        for (let {
                            ...
                            for (let a = o.length; a--;)
                                if (o[a] === s) return r.delegateTarget = s, i.oneOff && H.off(e, r.type, t, n), n.apply(s, [r]);
                        return null
                    }
                }(e, n, i) : function(e, t) {
                    return function n(i) {
        ...
        const H = {
                ...
                off(e, t, n, i) {
                    if ("string" != typeof t || !e) return;
                    const [r, o, s] = L(t, n, i), a = s !== t, l = N(e), c = t.startsWith(".");
                    if (void 0 !== o) {
                        if (!l || !l[s]) return;
                        return void M(e, l, s, o, r ? n : null)
                    }
                    c && Object.keys(l).forEach(n => {
                        ! function(e, t, n, i) {
                            ...
                            Object.keys(r).forEach(o => {
                                if (o.includes(i)) {
                                    const i = r[o];
                                    M(e, t, n, i.originalHandler, i.delegationSelector)
                                }
                            })
                        }(e, l, n, t.slice(1))
                    });
                    ...
                    Object.keys(u).forEach(n => {
                        ...
                        if (!a || t.includes(i)) {
                            const t = u[n];
                            M(e, l, s, t.originalHandler, t.delegationSelector)
                        }
                    })
                },
                trigger(e, t, n) {
                    ...
                    let a, l = !0,
                        ...
                        u = !1,
                        d = null;
                    return o && i && (a = i.Event(t, n), i(e).trigger(a), l = !a.isPropagationStopped(), c = !a.isImmediatePropagationStopped(), u = a.isDefaultPrevented()), s ? (d = document.createEvent("HTMLEvents")).initEvent(r, l, !0) : d = new CustomEvent(t, {
                        bubbles: l,
                        cancelable: !0
        ...
        class B {
            ...
            dispose() {
                R.remove(this._element, this.constructor.DATA_KEY), H.off(this._element, this.constructor.EVENT_KEY), Object.getOwnPropertyNames(this).forEach(e => {
                    this[e] = null
                })
            }
        ...
        const V = {
                ...
                getDataAttribute: (e, t) => Q(e.getAttribute(`data-bs-${U(t)}`)),
                offset(e) {
        ...
        class se extends B {
            ...
            pause(e) {
                e || (this._isPaused = !0), X.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (s(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }
            cycle(e) {
                e || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config && this._config.interval && !this._isPaused && (this._updateInterval(), this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval))
            }
            to(e) {
                this._activeElement = X.findOne(oe, this._element);
                const t = this._getItemIndex(this._activeElement);
                if (e > this._items.length - 1 || e < 0) return;
                if (this._isSliding) return void H.one(this._element, ie, () => this.to(e));
            ...
            _triggerSlideEvent(e, t) {
                const n = this._getItemIndex(e),
                    i = this._getItemIndex(X.findOne(oe, this._element));
                ...
                if (this._indicatorsElement) {
                    ...
                    for (let t = 0; t < n.length; t++)
                        if (Number.parseInt(n[t].getAttribute("data-bs-slide-to"), 10) === this._getItemIndex(e)) {
                            n[t].classList.add(re), n[t].setAttribute("aria-current", "true");
                            break
                        }
                }
            }
            _updateInterval() {
                const e = this._activeElement || X.findOne(oe, this._element);
                if (!e) return;
            ...
            _slide(e, t) {
                ...
                if (this._element.classList.contains("slide")) {
                    ...
                    const e = () => {
                        o.classList.remove(c, u), o.classList.add(re), i.classList.remove(re, u, c), this._isSliding = !1, setTimeout(f, 0)
                    };
                    this._queueCallback(e, i, !0)
                } else i.classList.remove(re), o.classList.add(re), this._isSliding = !1, f();
                a && this.cycle()
            }
            _directionToOrder(e) {
        ...
        H.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", se.dataApiClickHandler), H.on(window, "load.bs.carousel.data-api", () => {
        ...
        class me extends B {
            constructor(e, t) {
                ...
                for (let e = 0, t = n.length; e < t; e++) {
                    const t = n[e],
                        i = r(t),
                        o = X.find(i).filter(e => e === this._element);
            ...
            show() {
                ...
                if (this._config.parent) {
                    const e = X.find(he, this._config.parent);
                ...
                if (t.length) {
                    ...
                    if ((e = i ? me.getInstance(i) : null) && e._isTransitioning) return
                }
                if (H.trigger(this._element, "show.bs.collapse").defaultPrevented) return;
                t.forEach(t => {
                    n !== t && me.getOrCreateInstance(t, {
                        toggle: !1
                    }).hide(), e || R.set(t, "bs.collapse", null)
                });
                const i = this._getDimension();
                this._element.classList.remove(de), this._element.classList.add(fe), this._element.style[i] = 0, this._addAriaAndCollapsedClass(this._triggerArray, !0), this._isTransitioning = !0;
                const r = `scroll${i[0].toUpperCase()+i.slice(1)}`;
                this._queueCallback(() => {
                    this._isTransitioning = !1, this._element.classList.remove(fe), this._element.classList.add(de, ue), this._element.style[i] = "", H.trigger(this._element, "shown.bs.collapse")
            ...
            hide() {
                ...
                this._element.style[e] = `${this._element.getBoundingClientRect()[e]}px`, h(this._element), this._element.classList.add(fe), this._element.classList.remove(de, ue);
                ...
                this._isTransitioning = !0, this._element.style[e] = "", this._queueCallback(() => {
                    this._isTransitioning = !1, this._element.classList.remove(fe), this._element.classList.add(de), H.trigger(this._element, "hidden.bs.collapse")
                }, this._element, !0)
            }
            ...
            _initializeChildren() {
                ...
                const e = X.find(he, this._config.parent);
                X.find(ge, this._config.parent).filter(t => !e.includes(t)).forEach(e => {
                    const t = o(e);
        ...
        const ve = "dropdown",
            ...
            _e = "ArrowUp",
            we = "ArrowDown",
            xe = new RegExp("ArrowUp|ArrowDown|Escape"),
            Ee = "click.bs.dropdown.data-api",
            Te = "keydown.bs.dropdown.data-api",
            Ae = "show",
            Ce = '[data-bs-toggle="dropdown"]',
            Se = ".dropdown-menu",
            ke = v() ? "top-end" : "top-start",
            je = v() ? "top-start" : "top-end",
            Oe = v() ? "bottom-end" : "bottom-start",
            Ne = v() ? "bottom-start" : "bottom-end",
            De = v() ? "left-start" : "right-start",
            Le = v() ? "right-start" : "left-start",
            Pe = {
                offset: [0, 2],
        ...
        class Ie extends B {
            ...
            _completeHide(e) {
                H.trigger(this._element, "hide.bs.dropdown", e).defaultPrevented || ("ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(e => H.off(e, "mouseover", p)), this._popper && this._popper.destroy(), this._menu.classList.remove(Ae), this._element.classList.remove(Ae), this._element.setAttribute("aria-expanded", "false"), V.removeDataAttribute(this._menu, "popper"), H.trigger(this._element, "hidden.bs.dropdown", e))
            }
            _getConfig(e) {
            ...
            _getMenuElement() {
                return X.next(this._element, Se)[0]
            }
            _getPlacement() {
                ...
                return e.classList.contains("dropup") ? t ? je : ke : t ? Ne : Oe
            }
            _detectNavbar() {
            ...
            _selectMenuItem({
                ...
                const n = X.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter(u);
                n.length && w(n, t, e === we, !n.includes(t)).focus()
            }
            static jQueryInterface(e) {
                return this.each(function() {
            ...
            static dataApiKeydownHandler(e) {
                if (/input|textarea/i.test(e.target.tagName) ? e.key === be || e.key !== ye && (e.key !== we && e.key !== _e || e.target.closest(Se)) : !xe.test(e.key)) return;
                const t = this.classList.contains(Ae);
                if (!t && e.key === ye) return;
                if (e.preventDefault(), e.stopPropagation(), d(this)) return;
                const n = this.matches(Ce) ? this : X.prev(this, Ce)[0],
                    i = Ie.getOrCreateInstance(n);
                if (e.key !== ye) return e.key === _e || e.key === we ? (t || i.show(), void i._selectMenuItem(e)) : void(t && e.key !== be || Ie.clearMenus());
                i.hide()
            }
        }
        H.on(document, Te, Ce, Ie.dataApiKeydownHandler), H.on(document, Te, Se, Ie.dataApiKeydownHandler), H.on(document, Ee, Ie.clearMenus), H.on(document, "keyup.bs.dropdown.data-api", Ie.clearMenus), H.on(document, Ee, Ce, function(e) {
        ...
        class ze {
            ...
            show(e) {
                this._config.isVisible ? (this._append(), this._config.isAnimated && h(this._getElement()), this._getElement().classList.add($e), this._emulateAnimation(() => {
                    b(e)
                })) : b(e)
            }
            hide(e) {
                this._config.isVisible ? (this._getElement().classList.remove($e), this._emulateAnimation(() => {
                    this.dispose(), b(e)
                })) : b(e)
            }
            _getElement() {
            ...
            _getConfig(e) {
                return (e = { ...Be,
                    ..."object" == typeof e ? e : {}
                }).rootElement = l(e.rootElement), c("backdrop", e, We), e
            }
            _append() {
        ...
        class Ye {
            ...
            activate() {
                ...
                this._isActive || (t && e.focus(), H.off(document, Ve), H.on(document, "focusin.bs.focustrap", e => this._handleFocusin(e)), H.on(document, "keydown.tab.bs.focustrap", e => this._handleKeydown(e)), this._isActive = !0)
            }
            deactivate() {
                this._isActive && (this._isActive = !1, H.off(document, Ve))
            }
            _handleFocusin(e) {
                const {
                    target: t
        ...
        const Ke = "modal",
            ...
            rt = "keydown.dismiss.bs.modal",
            ot = "mousedown.dismiss.bs.modal",
            st = "modal-open",
            at = "show",
            lt = "modal-static";
        class ct extends B {
            constructor(e, t) {
                super(e), this._config = this._getConfig(t), this._dialog = X.findOne(".modal-dialog", this._element), this._backdrop = this._initializeBackDrop(), this._focustrap = this._initializeFocusTrap(), this._isShown = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollBar = new Re
            }
            static get Default() {
                return Je
            }
            ...
            show(e) {
                this._isShown || this._isTransitioning || H.trigger(this._element, tt, {
                    relatedTarget: e
                }).defaultPrevented || (this._isShown = !0, this._isAnimated() && (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(st), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), H.on(this._dialog, ot, () => {
            ...
            hide() {
                ...
                e && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), this._focustrap.deactivate(), this._element.classList.remove(at), H.off(this._element, it), H.off(this._dialog, ot), this._queueCallback(() => this._hideModal(), this._element, e)
            }
            dispose() {
            ...
            _setEscapeEvent() {
                this._isShown ? H.on(this._element, rt, e => {
                    this._config.keyboard && e.key === Ge ? (e.preventDefault(), this.hide()) : this._config.keyboard || e.key !== Ge || this._triggerBackdropTransition()
                }) : H.off(this._element, rt)
            }
            _setResizeEvent() {
                this._isShown ? H.on(window, nt, () => this._adjustDialog()) : H.off(window, nt)
            }
            _hideModal() {
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._isTransitioning = !1, this._backdrop.hide(() => {
                    document.body.classList.remove(st), this._resetAdjustments(), this._scrollBar.reset(), H.trigger(this._element, et)
                })
            }
            _showBackdrop(e) {
                H.on(this._element, it, e => {
            ...
            _triggerBackdropTransition() {
                ...
                !i && "hidden" === n.overflowY || e.contains(lt) || (i || (n.overflowY = "hidden"), e.add(lt), this._queueCallback(() => {
                    e.remove(lt), i || this._queueCallback(() => {
                        n.overflowY = ""
                    }, this._dialog)
        ...
        class mt extends B {
            ...
            show(e) {
                this._isShown || H.trigger(this._element, "show.bs.offcanvas", {
                    relatedTarget: e
                }).defaultPrevented || (this._isShown = !0, this._element.style.visibility = "visible", this._backdrop.show(), this._config.scroll || (new Re).hide(), this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(pt), this._queueCallback(() => {
            ...
            hide() {
                this._isShown && (H.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._focustrap.deactivate(), this._element.blur(), this._isShown = !1, this._element.classList.remove(pt), this._backdrop.hide(), this._queueCallback(() => {
                    this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._element.removeAttribute("role"), this._element.style.visibility = "hidden", this._config.scroll || (new Re).reset(), H.trigger(this._element, gt)
                }, this._element, !0)))
            }
            dispose() {
        ...
        H.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', function(e) {
            ...
            const n = X.findOne(ht);
            n && n !== t && mt.getInstance(n).hide(), mt.getOrCreateInstance(t).toggle(this)
        }), H.on(window, "load.bs.offcanvas.data-api", () => X.find(ht).forEach(e => mt.getOrCreateInstance(e).show())), W(mt), y(mt);
        ...
        function wt(e, t, n) {
            ...
            for (let e = 0, n = r.length; e < n; e++) {
                ...
                const o = [].concat(...n.attributes),
                    s = [].concat(t["*"] || [], t[i] || []);
                o.forEach(e => {
                    _t(e, s) || n.removeAttribute(e.nodeName)
                })
            }
            return i.body.innerHTML
        }
        const xt = "tooltip",
            Et = new Set(["sanitize", "allowList", "sanitizeFn"]),
            Tt = {
                animation: "boolean",
                template: "string",
        ...
        class Ht extends B {
            ...
            toggle(e) {
                if (this._isEnabled)
                    if (e) {
                        ...
                        if (this.getTipElement().classList.contains(jt)) return void this._leave(null, this);
                        this._enter(null, this)
                    }
            }
            dispose() {
                clearTimeout(this._timeout), H.off(this._element.closest(Lt), Pt, this._hideModalHandler), this.tip && this.tip.remove(), this._disposePopper(), super.dispose()
            }
            show() {
                ...
                "tooltip" === this.constructor.NAME && this.tip && this.getTitle() !== this.tip.querySelector(Dt).innerHTML && (this._disposePopper(), this.tip.remove(), this.tip = null);
                ...
                r.setAttribute("id", o), this._element.setAttribute("aria-describedby", o), this._config.animation && r.classList.add(kt);
                ...
                R.set(r, this.constructor.DATA_KEY, this), this._element.ownerDocument.documentElement.contains(this.tip) || (l.append(r), H.trigger(this._element, this.constructor.Event.INSERTED)), this._popper ? this._popper.update() : this._popper = t.createPopper(this._element, r, this._getPopperConfig(a)), r.classList.add(jt);
                const c = this._resolvePossibleFunction(this._config.customClass);
                c && r.classList.add(...c.split(" ")), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(e => {
                    H.on(e, "mouseover", p)
                });
                const u = this.tip.classList.contains(kt);
                this._queueCallback(() => {
                    const e = this._hoverState;
                    this._hoverState = null, H.trigger(this._element, this.constructor.Event.SHOWN), e === Nt && this._leave(null, this)
                }, this.tip, u)
            }
            hide() {
                ...
                e.classList.remove(jt), "ontouchstart" in document.documentElement && [].concat(...document.body.children).forEach(e => H.off(e, "mouseover", p)), this._activeTrigger.click = !1, this._activeTrigger.focus = !1, this._activeTrigger.hover = !1;
                const t = this.tip.classList.contains(kt);
                this._queueCallback(() => {
                    this._isWithActiveTrigger() || (this._hoverState !== Ot && e.remove(), this._cleanTipClass(), this._element.removeAttribute("aria-describedby"), H.trigger(this._element, this.constructor.Event.HIDDEN), this._disposePopper())
            ...
            getTipElement() {
                ...
                return this.setContent(t), t.classList.remove(kt, jt), this.tip = t, this.tip
            }
            setContent(e) {
                this._sanitizeAndSetContent(e, this.getTitle(), Dt)
            }
            ...
            _setListeners() {
                this._config.trigger.split(" ").forEach(e => {
                    if ("click" === e) H.on(this._element, this.constructor.Event.CLICK, this._config.selector, e => this.toggle(e));
                        ...
                        const t = e === Mt ? this.constructor.Event.MOUSEENTER : this.constructor.Event.FOCUSIN,
                            n = e === Mt ? this.constructor.Event.MOUSELEAVE : this.constructor.Event.FOCUSOUT;
                ...
                }), H.on(this._element.closest(Lt), Pt, this._hideModalHandler), this._config.selector ? this._config = { ...this._config,
                    trigger: "manual",
                    selector: ""
                } : this._fixTitle()
            }
            ...
            _enter(e, t) {
                t = this._initializeOnDelegatedTarget(e, t), e && (t._activeTrigger["focusin" === e.type ? It : Mt] = !0), t.getTipElement().classList.contains(jt) || t._hoverState === Ot ? t._hoverState = Ot : (clearTimeout(t._timeout), t._hoverState = Ot, t._config.delay && t._config.delay.show ? t._timeout = setTimeout(() => {
                    t._hoverState === Ot && t.show()
                }, t._config.delay.show) : t.show())
            }
            _leave(e, t) {
                t = this._initializeOnDelegatedTarget(e, t), e && (t._activeTrigger["focusout" === e.type ? It : Mt] = t._element.contains(e.relatedTarget)), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = Nt, t._config.delay && t._config.delay.hide ? t._timeout = setTimeout(() => {
            ...
            _getConfig(e) {
                ...
                return Object.keys(t).forEach(e => {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), c(xt, e, this.constructor.DefaultType), e.sanitize && (e.template = wt(e.template, e.allowList, e.sanitizeFn)), e
            }
            _getDelegateConfig() {
                const e = {};
        ...
        class Xt extends B {
            ...
            refresh() {
                const e = this._scrollElement === this._scrollElement.window ? "offset" : Vt,
                    t = "auto" === this._config.method ? e : this._config.method,
                    n = t === Vt ? this._getScrollTop() : 0;
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), X.find(Ut, this._config.target).map(e => {
                    const i = r(e),
                        o = i ? X.findOne(i) : null;
                    if (o) {
                        const e = o.getBoundingClientRect();
                        if (e.width || e.height) return [V[t](o).top + n, i]
                    }
                    return null
            ...
            _getConfig(e) {
                return (e = { ...Ft,
                    ...V.getDataAttributes(this._element),
                    ..."object" == typeof e && e ? e : {}
                }).target = l(e.target) || document.documentElement, c($t, e, zt), e
            }
            _getScrollTop() {
            ...
            _activate(e) {
                ...
                const t = Ut.split(",").map(t => `${t}[data-bs-target="${e}"],${t}[href="${e}"]`),
                    n = X.findOne(t.join(","), this._config.target);
                n.classList.add(Qt), n.classList.contains("dropdown-item") ? X.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add(Qt) : X.parents(n, ".nav, .list-group").forEach(e => {
                    X.prev(e, ".nav-link, .list-group-item").forEach(e => e.classList.add(Qt)), X.prev(e, ".nav-item").forEach(e => {
                        X.children(e, ".nav-link").forEach(e => e.classList.add(Qt))
                    })
            ...
            _clear() {
                X.find(Ut, this._config.target).filter(e => e.classList.contains(Qt)).forEach(e => e.classList.remove(Qt))
            }
            static jQueryInterface(e) {
                return this.each(function() {
        ...
        H.on(window, "load.bs.scrollspy.data-api", () => {
            X.find('[data-bs-spy="scroll"]').forEach(e => new Xt(e))
        }), y(Xt);
        const Yt = "active",
            Kt = "fade",
            Gt = "show",
        ...
        class en extends B {
            ...
            show() {
                if (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains(Yt)) return;
                let e;
                const t = o(this._element),
                    n = this._element.closest(".nav, .list-group");
                if (n) {
                    const t = "UL" === n.nodeName || "OL" === n.nodeName ? Zt : Jt;
                    e = (e = X.find(t, n))[e.length - 1]
                }
                const i = e ? H.trigger(e, "hide.bs.tab", {
                    relatedTarget: this._element
                }) : null;
            ...
            _activate(e, t, n) {
                const i = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? X.children(t, Jt) : X.find(Zt, t))[0],
                    r = n && i && i.classList.contains(Kt),
                    o = () => this._transitionComplete(e, i, n);
                i && r ? (i.classList.remove(Gt), this._queueCallback(o, e, !0)) : o()
            }
            _transitionComplete(e, t, n) {
                if (t) {
                    t.classList.remove(Yt);
                    const e = X.findOne(":scope > .dropdown-menu .active", t.parentNode);
                    e && e.classList.remove(Yt), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !1)
                }
                e.classList.add(Yt), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), h(e), e.classList.contains(Kt) && e.classList.add(Gt);
                let i = e.parentNode;
                if (i && "LI" === i.nodeName && (i = i.parentNode), i && i.classList.contains("dropdown-menu")) {
                    const t = e.closest(".dropdown");
                    t && X.find(".dropdown-toggle", t).forEach(e => e.classList.add(Yt)), e.setAttribute("aria-expanded", !0)
                }
                n && n()
            }
            static jQueryInterface(e) {
        ...
        class ln extends B {
            ...
            show() {
                H.trigger(this._element, "show.bs.toast").defaultPrevented || (this._clearTimeout(), this._config.animation && this._element.classList.add("fade"), this._element.classList.remove(nn), h(this._element), this._element.classList.add(rn), this._element.classList.add(on), this._queueCallback(() => {
                    this._element.classList.remove(on), H.trigger(this._element, "shown.bs.toast"), this._maybeScheduleHide()
                }, this._element, this._config.animation))
            }
            hide() {
                this._element.classList.contains(rn) && (H.trigger(this._element, "hide.bs.toast").defaultPrevented || (this._element.classList.add(on), this._queueCallback(() => {
                    this._element.classList.add(nn), this._element.classList.remove(on), this._element.classList.remove(rn), H.trigger(this._element, "hidden.bs.toast")
                }, this._element, this._config.animation)))
            }
            dispose() {
